...
print("a:",a)
print("b:",b)
print("convert existind string 'a' to RAW FORMAT:", repr(a))#repr(inbuilt fun)
...
my_string = "WEL COME" # 0 1 2 3 4 5 6 7
                       # w e l   c o m e
                       #-8-7-6-5-4-3-2-1
...
print("Substring from index 1 to 6 using + ve index no:", my_string[1:6])#el co
...
# Which means, from 1 to 6 give me every character wel come
...
# Step Value=1
# Which means, from 1 to 6 give me every character  (start:stop:step)

print("Substring from index 1 to 6 using + ve index no step by '2':", my_string[1:6:2])#e o
